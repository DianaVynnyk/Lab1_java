...
public class Shoes {
	...
	public Shoes(String manufacturer, String color, int price, int size, String country, String material,
			String forWhomItIsIntended, String typeOfShoes) {
	...
	public void resetValues(String manufacturer, String color, int price, int size, String country, String material,
			String forWhomItIsIntended, String typeOfShoes) {
		this.manufacturer = manufacturer;
		this.color = color;
		this.price = price;
	...
	public static void main(String[] args) {
		...
		Shoes boots2 = new Shoes("Alban", "black", 4000, 38);
